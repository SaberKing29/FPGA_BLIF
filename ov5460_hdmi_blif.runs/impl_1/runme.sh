...
HD_PWD='E:/code/luoyuedong/fpga/blif/blif_10_16/ov5460_hdmi_blif/ov5460_hdmi_blif.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ov5640_hdmi_bli_filter.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ov5640_hdmi_bli_filter.tcl -notrace
