...
HD_PWD='E:/code/luoyuedong/fpga/blif/blif_10_16/ov5460_hdmi_blif/ov5460_hdmi_blif.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ov5640_hdmi_bli_filter.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ov5640_hdmi_bli_filter.tcl
