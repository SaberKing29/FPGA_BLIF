...
map_setup_file()
{
  ...
  if [[ ($1 != "") ]]; then
    ...
    lib_map_path="E:/A7/zhengdianyuanzi/logic/dafengqi/ov5640_hdmi_median_filter/ov5640_hdmi_median_filter/ov5640_hdmi_median_filter.cache/compile_simlib/riviera"
  fi
